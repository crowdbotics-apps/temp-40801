"""
Django settings for temp_40801 project.
...
WSGI_APPLICATION = 'temp_40801.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "temp_40801 API",
    "DESCRIPTION": "API documentation for temp_40801 App",
    "VERSION": "v1",
}
